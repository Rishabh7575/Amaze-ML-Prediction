...
# Central Configuration, Helpers, Fusion and Models Modules
import config
...
# ==============================================================================
# 5. Main Execution Pipeline Entrypoint
# ==============================================================================
...
def main():
    ...
    # Multi-modal Feature Engineering (Defaults to Text modality only for baseline run compatibility)
    X_train, X_test = prepare_features(train_df, test_df, use_text=True, use_image=False)

    # 1. Train and Evaluate Scaled Linear Regression Baseline
